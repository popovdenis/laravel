...
namespace Modules\LanguageLevel\Filament\Resources;
...
class LanguageLevelResource extends Resource
{
    ...
    {
        return [
            LanguageLevelResource\RelationManagers\SubjectRelationManager::class,
        ];
    }
    ...
    {
        return [
            'index' => LanguageLevelResource\Pages\ListLevel::route('/'),
            'create' => LanguageLevelResource\Pages\CreateLevel::route('/create'),
            'edit' => LanguageLevelResource\Pages\EditLevel::route('/{record}/edit'),
        ];
    }
}
