...
namespace Modules\ScheduleTimeslot\Providers;
...
class ScheduleTimeslotServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'ScheduleTimeslot';

    protected string $nameLower = 'scheduletimeslot';
