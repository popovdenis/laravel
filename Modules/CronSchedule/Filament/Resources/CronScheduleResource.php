...
namespace Modules\CronSchedule\Filament\Resources;
...
//                        \App\Models\Meeting::class => 'Meeting',
    ...
    {
        return [
            'index' => CronScheduleResource\Pages\ListCronSchedules::route('/'),
            'create' => CronScheduleResource\Pages\CreateCronSchedule::route('/create'),
            'edit' => CronScheduleResource\Pages\EditCronSchedule::route('/{record}/edit'),
        ];
    }
}
