                    ...
                    <div class='row' style=' margin: 10px; background: #eee; overflow:auto; padding:5px;'>
                        ...
                        <div class='col-md-12 '>
                            ...
                            <p class='text-center'><a
                                        href='{{asset(     config("blog.blog_upload_dir") . "/". $file['filename'])}}'
                                        target='_blank'>[link]</a> / <span
                                        class='btn btn-sm btn-primary'
                                        style='cursor: zoom-in;'
                                        onclick='show_uploaded_file_row("{{$id}}","{{asset(     config("blog.blog_upload_dir") . "/". $file['filename'])}}")'>show</span>
                            </p>
                        ...
                        <div class='col-md-6 {{$id}}' style='display:none;'>
                            <div style=''>
                                ...
                                <input type='text' readonly='readonly' class='form-control'
                                       value='{{asset(     config("blog.blog_upload_dir") . "/". $file['filename'])}}'>
                            </div>
                        </div>
                        <div class='col-md-6 {{$id}}' style='display:none;'>
                            ...
                            <div style=''>
                                ...
                                <input type='text' readonly='readonly' class='form-control'
                                       value='{{"<img src='".asset(     config("blog.blog_upload_dir") . "/". $file['filename'])."' alt='" . e($uploadedPhoto->image_title) . "' >"}}'>
                            </div>
                        </div>
                ...
                <div class='col-md-4'>
                    @if($smallest)
                        ...
                        <div style='text-align:center;'>
                            <a style='cursor: zoom-in;' href='{{asset(     config("blog.blog_upload_dir") . "/". $smallest['filename'])}}'
                               target='_blank'>
                                <img src='{{asset(     config("blog.blog_upload_dir") . "/". $smallest['filename'])}}'
