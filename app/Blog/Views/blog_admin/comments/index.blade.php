    ...
    @forelse ($comments as $comment)
        ...
        <div class="card m-4" >
            <div class="card-body">
                ...
                @if(!$comment->approved)
                    {{--APPROVE BUTTON--}}
                    <form method='post' action='{{route("blog.admin.comments.approve", $comment->id)}}' class='float-right'>
                        @csrf
                        @method("PATCH")
                ...
                <form
                        ...
                        method='post' action='{{route("blog.admin.comments.delete", $comment->id)}}' class='float-right'>
                    @csrf
                    @method("DELETE")
