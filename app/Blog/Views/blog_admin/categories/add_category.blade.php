...
@section("content")
    ...
    <form method='post' action='{{route("blog.admin.categories.create_category")}}'  enctype="multipart/form-data" >
        ...
        <div class="form-group">
            ...
            <small id="category_slug_help" class="form-text text-muted">
                ...
                i.e. {{route("blog.view_category",[app('request')->get('locale'),""])}}/<u><em>this_part</em></u>. This must be unique (two categories can't
                share the same slug).
...
//        alert("A");
            ...
            $('#submit-btn').click(function (){
                ...
                $.post('{{route("blog.admin.categories.store_category")}}' ,
                    {
                        data: languageList,
                    ...
                    function(data, status){
                        ...
                        window.location.replace("{{route('blog.admin.categories.index')}}");
                    });
            });
