        ...
        <div class="card m-4">
            <div class="card-body">
                ...
                <form
                        ...
                        method='post' action='{{route("blog.admin.languages.toggle_language", $language->id)}}' class='float-left'>
                    @csrf
                ...
                <form
                        ...
                        method='post' action='{{route("blog.admin.languages.destroy_language", $language->id)}}' class='float-right'>
                    @csrf
                    @method("DELETE")
