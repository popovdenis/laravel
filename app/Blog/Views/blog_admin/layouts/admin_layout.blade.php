        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class='nav-item px-2'><a class='nav-link' href='{{route("blog.index" , app('request')->get('locale'))}}' target="_blank">Blog home</a></li>
        ...
        <div class="container">
            <div class='row full-width-div nav-bar-full'>
                ...
                <div class='col-md-9 main-content'>
                    ...
                    @if(\Blog\Helpers::has_flashed_message())
                        <div class='alert alert-info'>
                            <h3>{{\Blog\Helpers::pull_flashed_message() }}</h3>
                        </div>
                    @endif
