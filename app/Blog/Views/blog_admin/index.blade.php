...
@section("content")
    ...
    @if($post_translations)
        <div class='search-form-outer mb-3'>
            <form method='get' action='{{route("blog.admin.searchblog", app('request')->get('locale'))}}' class='text-center'>
        ...
        <div class="card m-4" style="">
            <div class="card-body">
                ...
                <form onsubmit="return confirm('Are you sure you want to delete this blog post?\n You cannot undo this action!');"
                      method='post' action='{{route("blog.admin.destroy_post", $post->post_id)}}' class='float-right'>
                    @csrf
