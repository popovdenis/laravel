<div class='add_comment_area'>
    ...
    <form method='post' action='{{route("blog.comments.add_new_comment",[app('request')->get('locale'),$post->slug])}}'>
        @csrf
        ...
        <div class='container-fluid'>
            <div class='row'>
                ...
                @if(config("blog.comments.save_user_id_if_logged_in", true) == false || !\Auth::check())
