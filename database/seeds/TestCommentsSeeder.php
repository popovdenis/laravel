...
class TestCommentsSeeder extends Seeder
{
    public function run()
    {
        ...
        /*
         * Таблица (постов, записей, рубрик и тд.) к которой
         * привязывается каждый комментарий
         */
         ...
         * т.е. вывод комментариев будет осуществлен на странице вывода поста
         * (записи, рубрики и тд.) с данным id
         */
