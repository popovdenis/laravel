...
class Move
{
     ...
     * supplied parameter is an instance of \App\Blog\Baum\Node. Otherwise it will try
    ...
    {
        if ($node instanceof \App\Blog\Baum\Node) return $node->reload();
    ...
    protected function bound2()
    {
        ...
        $this->_bound2 = (($this->bound1() > $this->node->getRight()) ? $this->node->getRight()
            + 1 : $this->node->getLeft() - 1);
        return $this->_bound2;
    }
