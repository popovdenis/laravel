...
@if(count($comments)> config("blog.comments.max_num_of_comments_to_show",500) - 1)
    <p><em>Only the first {{config("blog.comments.max_num_of_comments_to_show",500)}} comments are
            shown.</em>
    </p>
@endif
