...
@section("content")
    ...
    <form id="edit-post-form" method='post' action='{{route("blog.admin.update_post",$post->id)}}'  enctype="multipart/form-data" >
    ...
    <script>
        //multi language
        var edit_toggle_url = '{{route("blog.admin.edit_post_toggle",$post->id)}}';
